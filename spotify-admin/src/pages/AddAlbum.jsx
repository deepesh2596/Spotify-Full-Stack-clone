  ...
  return loading ? (
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600'>
      ...
      <div className='flex flex-col gap-2.5'>
        ...
        <input onChange={(e)=>setDesc(e.currentTarget.value)} value={desc} className='bg-transparent outline-green-600 border-2 border-gray-400 p-2.5 w-[max(40vw,250px)]' type="text" placeholder='Type here' />
      </div>
